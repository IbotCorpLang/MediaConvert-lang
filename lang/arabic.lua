...
function ar.lang()
    local texts = {
        ...
        markdownerr = "حدث خطأ اثناء اضافه النص\nهنالك نص ماركداون غير مكتمل, يمكنك التخلص من احرف الماركداون الغير منتهية من خلال وضع \"\\\"\nللمزيد من المعلومات /markdown",
        markdownhelp = "كيفية تخطي احرف الماركداون:\nكل ما عليك هو ان تضع \"\\\" امام حرف الماركداون لتخطيه\nاحرف الماركداون: _, *, [, ], (, ), ~, `, >, #, +, -, =, |, {, }, ., !",
        ...
        share = {
            video = "مشاركة الفيديو",
            audio = "مشاركة المقطع الصوتي",
            sticker = "مشاركة الملصق",
            gif = "مشاركة المتحركة",
